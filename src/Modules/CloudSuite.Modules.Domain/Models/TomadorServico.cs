...
namespace CloudSuite.Modules.Domain.Models
{
    ...
    {
        public TomadorServico(Cnpj cnpj, string? inscricaoMunicipal, string? inscricaoEstadual, string? docTomadorEstrangeiro, string? socialReason, string nomeFantasia, Address address, int tipo)
        {
            Cnpj = cnpj;
