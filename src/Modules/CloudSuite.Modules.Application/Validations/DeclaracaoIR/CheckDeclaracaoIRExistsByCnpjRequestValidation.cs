...
{
    public class CheckDeclaracaoIRExistsByCnpjRequestValidation : AbstractValidator<CheckDeclaracaoIRExistsByCnpjRequest>
    {
        public CheckDeclaracaoIRExistsByCnpjRequestValidation()
        {
            RuleFor(a => a.Cnpj)
