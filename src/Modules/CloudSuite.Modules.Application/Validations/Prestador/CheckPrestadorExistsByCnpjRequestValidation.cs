...
{
    public class CheckPrestadorExistsByCnpjRequestValidation : AbstractValidator<CheckPrestadorExistsByCnpjRequest>
    {
        public CheckPrestadorExistsByCnpjRequestValidation()
        {
            RuleFor(a => a.Cnpj)
