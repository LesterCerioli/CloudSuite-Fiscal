...
{
    public class CheckCancelOrderExistsByCnpjRequestValidation : AbstractValidator<CheckCancelOrderExistsByCnpjRequest>
    {
        public CheckCancelOrderExistsByCnpjRequestValidation()
        {
            RuleFor(a => a.Cnpj)
